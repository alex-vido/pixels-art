...
* Use o comando: `git clone git@github.com:tryber/sd-032-b-project-pixels-art.git`
* Entre na pasta do repositório que você acabou de clonar:
  * `cd sd-032-b-project-pixels-art`
...
* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-b-project-pixels-art/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-b-project-pixels-art/pulls) e confira que o seu _Pull Request_ está criado
...
Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-B&template=betrybe/sd-0x-project-pixels-art)
